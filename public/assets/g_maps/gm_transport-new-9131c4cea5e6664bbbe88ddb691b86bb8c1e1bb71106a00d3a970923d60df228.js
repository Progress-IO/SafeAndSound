...
function initMap() {
  ...
  $("#btnaddmarker").click(function(){
      addMarker(bogota, img_marker_bus);
      $(this).fadeOut(500);
  });
  ...
  $("#btn-location").click(function(){
      ...
      $("#transport_latitude").val(crime_lat);
      $("#transport_longitude").val(crime_lng);
