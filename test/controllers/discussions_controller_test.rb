...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post discussions_url, params: { discussion: { content: @discussion.content, headline: @discussion.headline } }
  #   end
  ...
  #   patch discussion_url(@discussion), params: { discussion: { content: @discussion.content, headline: @discussion.headline } }
