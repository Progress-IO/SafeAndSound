...
class SuspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post suspects_url, params: { suspect: { address: @suspect.address, details: @suspect.details, fecha: @suspect.fecha, latitude: @suspect.latitude, longitude: @suspect.longitude} }
  #   end
