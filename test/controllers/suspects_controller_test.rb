...
class SuspectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create suspect" do
    assert_difference('Suspect.count') do
      post suspects_url, params: { suspect: { address: @suspect.address, details: @suspect.details, fecha: @suspect.fecha, latitude: @suspect.latitude, longitude: @suspect.longitude, nombre: @suspect.nombre } }
    end
  ...
  test "should update suspect" do
    patch suspect_url(@suspect), params: { suspect: { address: @suspect.address, details: @suspect.details, fecha: @suspect.fecha, latitude: @suspect.latitude, longitude: @suspect.longitude, nombre: @suspect.nombre } }
